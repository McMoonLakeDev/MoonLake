 ...
 * @author Month_Light
 */
public interface MoonLakePlayer extends AbilityPlayer, AttributePlayer, InventoryPlayer, NMSPlayer, InternetPlayer, SkinmePlayer, DependPlayer, Comparable<MoonLakePlayer>, VersionAdapter.Minecraft {
