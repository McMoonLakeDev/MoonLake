 ...
 * @author Month_Light
 */
class AnvilWindowExpression_v1_8_R1 extends ContainerAnvil implements VersionAdapter.MinecraftBukkit {
     ...
     */
    public AnvilWindowExpression_v1_8_R1(Player owner, AnvilWindowExpression anvilWindow) {
    ...
    public MinecraftBukkitVersion mcBukkitVersion() {
        ...
        return MinecraftBukkitVersion.V1_8_R1;
    }
}
