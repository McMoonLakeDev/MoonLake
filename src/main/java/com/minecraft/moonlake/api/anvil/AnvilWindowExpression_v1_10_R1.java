...
/**
 * <h1>AnvilWindowExpression_v1_10_R1</h1>
 * 铁砧窗口 v1.10-R1 版容器类
 *
 * @version 2.0
 * @author Month_Light
 */
class AnvilWindowExpression_v1_10_R1 extends ContainerAnvil implements VersionAdapter.MinecraftBukkit {
     ...
     */
    public AnvilWindowExpression_v1_10_R1(Player owner, AnvilWindowExpression anvilWindow) {
    ...
    public MinecraftBukkitVersion mcBukkitVersion() {
        ...
        return MinecraftBukkitVersion.V1_10_R1;
    }
}
