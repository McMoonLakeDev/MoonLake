...
/**
 * <h1>AnvilWindowExpression_v1_12_R1</h1>
 * 铁砧窗口 v1.12-R1 版容器类
 *
 * @version 1.0
 * @author Month_Light
 */
class AnvilWindowExpression_v1_12_R1 extends ContainerAnvil implements VersionAdapter.MinecraftBukkit {

    private final Player owner;
    private final AnvilWindowExpression anvilWindow;

    /**
     * 铁砧窗口 v1.12-R1 版容器类构造函数
     *
     * @param owner 拥有者
     * @param anvilWindow 铁砧窗口
     */
    public AnvilWindowExpression_v1_12_R1(Player owner, AnvilWindowExpression anvilWindow) {
    ...
    public MinecraftBukkitVersion mcBukkitVersion() {
        ...
        return MinecraftBukkitVersion.V1_12_R1;
    }
}
