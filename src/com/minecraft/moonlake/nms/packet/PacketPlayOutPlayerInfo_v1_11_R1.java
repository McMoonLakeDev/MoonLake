...
/**
 * <h1>PacketPlayOutPlayerInfo_v1_11_R1</h1>
 * 数据包输出玩家信息 v1.11-R1 实现类（详细doc待补充...）
 *
 * @version 1.0
 * @author Month_Light
 */
class PacketPlayOutPlayerInfo_v1_11_R1 extends PacketPlayOutPlayerInfo<PacketPlayOutPlayerInfo_v1_11_R1> {
    ...
    static {
        ...
        try {
            ...
            CLASS_PACKETPLAYOUTPLAYERINFO = net.minecraft.server.v1_11_R1.PacketPlayOutPlayerInfo.class;
            CLASS_PACKETPLAYOUTPLAYERINFO_ENUMPLAYERINFOACTION = net.minecraft.server.v1_11_R1.PacketPlayOutPlayerInfo.EnumPlayerInfoAction.class;
    ...
    /**
     * 数据包输出玩家信息 v1.11-R1 实现类
     *
     * @deprecated 已过时，请使用 {@link #PacketPlayOutPlayerInfo_v1_11_R1(Action, Player)}
     * @see #PacketPlayOutPlayerInfo_v1_11_R1(Action, Player)
     */
    @Deprecated
    public PacketPlayOutPlayerInfo_v1_11_R1() {
     ...
     * @param player 玩家
     */
    public PacketPlayOutPlayerInfo_v1_11_R1(Action action, Player player) {
    ...
    public void send(Player... players) throws PacketException {
        ...
        try {
            ...
            Object packet = packetConstructor.newInstance(enumPlayerInfoAction, new net.minecraft.server.v1_11_R1.EntityPlayer[] { (net.minecraft.server.v1_11_R1.EntityPlayer) nmsPlayer });
