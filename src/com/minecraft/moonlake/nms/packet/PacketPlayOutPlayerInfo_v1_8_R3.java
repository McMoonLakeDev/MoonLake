...
class PacketPlayOutPlayerInfo_v1_8_R3 extends PacketPlayOutPlayerInfo<PacketPlayOutPlayerInfo_v1_8_R3> {
    ...
    static {
        ...
        try {
            ...
            CLASS_PACKETPLAYOUTPLAYERINFO = net.minecraft.server.v1_8_R3.PacketPlayOutPlayerInfo.class;
            CLASS_PACKETPLAYOUTPLAYERINFO_ENUMPLAYERINFOACTION = net.minecraft.server.v1_8_R3.PacketPlayOutPlayerInfo.EnumPlayerInfoAction.class;
    ...
    public void send(Player... player) throws PacketException {
        ...
        try {
            ...
            Constructor<?> packetConstructor = getConstructor(CLASS_PACKETPLAYOUTPLAYERINFO, CLASS_PACKETPLAYOUTPLAYERINFO_ENUMPLAYERINFOACTION, net.minecraft.server.v1_8_R3.EntityPlayer[].class);
            Object packet = packetConstructor.newInstance(enumPlayerInfoAction, new net.minecraft.server.v1_8_R3.EntityPlayer[] { (net.minecraft.server.v1_8_R3.EntityPlayer) nmsPlayer });
