...
/**
 * <h1>PacketPlayOutPlayerInfo_v1_8_R2</h1>
 * 数据包输出玩家信息 v1.8-R2 实现类（详细doc待补充...）
 *
 * @version 1.0
 * @author Month_Light
 */
class PacketPlayOutPlayerInfo_v1_8_R2 extends PacketPlayOutPlayerInfo<PacketPlayOutPlayerInfo_v1_8_R2> {
    ...
    /**
     * 数据包输出玩家信息 v1.8-R2 实现类
     *
     * @deprecated 已过时，请使用 {@link #PacketPlayOutPlayerInfo_v1_8_R2(Action, Player)}
     * @see #PacketPlayOutPlayerInfo_v1_8_R2(Action, Player)
     */
    @Deprecated
