 ...
 */
public class PacketPlayOutPlayerInfo_v1_8_R2 extends PacketPlayOutPlayerInfo {

    public PacketPlayOutPlayerInfo_v1_8_R2(PlayerInfoAction action, Player player) {
    ...
    public void send(String... names) {
        ...
        try {
            ...
            Constructor<?> Constructor = Reflect.getConstructor(PacketPlayOutPlayerInfo, EnumPlayerInfoAction, net.minecraft.server.v1_8_R2.EntityPlayer[].class);
            Object ppopi = Constructor.newInstance(EnumPlayerInfoAction0, new net.minecraft.server.v1_8_R2.EntityPlayer[] {(net.minecraft.server.v1_8_R2.EntityPlayer) NMSPlayerSource});
