 ...
 */
public class PacketPlayOutPlayerInfo_v1_8_R1 extends PacketPlayOutPlayerInfo {

    public PacketPlayOutPlayerInfo_v1_8_R1(PlayerInfoAction action, Player player) {
    ...
    public void send(String... names) {
        ...
        try {
            ...
            Constructor<?> Constructor = Reflect.getConstructor(PacketPlayOutPlayerInfo, EnumPlayerInfoAction, net.minecraft.server.v1_8_R1.EntityPlayer[].class);
            Object ppopi = Constructor.newInstance(EnumPlayerInfoAction0, new net.minecraft.server.v1_8_R1.EntityPlayer[] {(net.minecraft.server.v1_8_R1.EntityPlayer) NMSPlayerSource});
