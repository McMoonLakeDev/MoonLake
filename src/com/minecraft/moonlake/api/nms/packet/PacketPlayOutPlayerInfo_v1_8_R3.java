 ...
 */
public class PacketPlayOutPlayerInfo_v1_8_R3 extends PacketPlayOutPlayerInfo {

    public PacketPlayOutPlayerInfo_v1_8_R3(PlayerInfoAction action, Player player) {
    ...
    public void send(String... names) {
        ...
        try {
            ...
            Object ppopi = Constructor.newInstance(EnumPlayerInfoAction0, new net.minecraft.server.v1_8_R3.EntityPlayer[] {(net.minecraft.server.v1_8_R3.EntityPlayer) NMSPlayerSource});
