...
open class MoonLakePlayerImpl_v1_12_R1 : MoonLakePlayerImpl_v1_11_R1 {
    ...
    override fun send(component: ChatComponent, action: ChatAction) {
        val connection = (getBukkitPlayer() as org.bukkit.craftbukkit.v1_12_R1.entity.CraftPlayer).handle.playerConnection
        val iChatBaseComponent = ChatSerializer.toNMS(component) as net.minecraft.server.v1_12_R1.IChatBaseComponent
        val packet = net.minecraft.server.v1_12_R1.PacketPlayOutChat(iChatBaseComponent, net.minecraft.server.v1_12_R1.ChatMessageType.a(action.value()))
