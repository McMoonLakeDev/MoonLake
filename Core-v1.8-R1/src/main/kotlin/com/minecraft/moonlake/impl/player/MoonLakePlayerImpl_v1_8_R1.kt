...
open class MoonLakePlayerImpl_v1_8_R1 : MoonLakePlayerBase {
    ...
    override fun send(component: ChatComponent, action: ChatAction) {
        val connection = (getBukkitPlayer() as org.bukkit.craftbukkit.v1_8_R1.entity.CraftPlayer).handle.playerConnection
        val iChatBaseComponent = ChatSerializer.toNMS(component) as net.minecraft.server.v1_8_R1.IChatBaseComponent
        val packet = net.minecraft.server.v1_8_R1.PacketPlayOutChat(iChatBaseComponent, action.value())
